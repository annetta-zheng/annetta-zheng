...
lunr.Pipeline.prototype.run = function(t) {
    for (var e = [], n = t.length, r = this._stack.length, i = 0; n > i; i++) {
        for (var o = t[i], s = 0; r > s && (o = this._stack[s](o, i, t), void 0 !== o); s++)
            ;
        void 0 !== o && e.push(o)
    }
    return e
...
lunr.Vector.prototype.magnitude = function() {
    ...
    for (var t, e = 0, n = this.elements, r = n.length, i = 0; r > i; i++)
        t = n[i],
        e += t * t;
    return this._magnitude = Math.sqrt(e)
},
lunr.Vector.prototype.dot = function(t) {
    for (var e = this.elements, n = t.elements, r = e.length, i = 0, o = 0; r > o; o++)
        i += e[o] * n[o];
    return i
},
...
lunr.SortedSet.prototype.indexOf = function(t, e, n) {
    var e = e || 0,
        ...
        i = e + Math.floor(r / 2),
        o = this.elements[i];
    return 1 >= r ? o === t ? i : -1 : t > o ? this.indexOf(t, i, n) : o > t ? this.indexOf(t, e, i) : o === t ? i : void 0
},
lunr.SortedSet.prototype.locationFor = function(t, e, n) {
    ...
    return t > o ? this.locationFor(t, i, n) : o > t ? this.locationFor(t, e, i) : void 0
},
...
lunr.Index.prototype.add = function(t, e) {
    ...
    this._fields.forEach(function(e) {
        ...
        n[e.name] = i,
        lunr.SortedSet.prototype.add.apply(r, i)
    }, this),
    this.documentStore.set(i, r),
    ...
    e.forEach(function(t, e, o) {
        var s = 1 / o.length * this._fields.length * i,
            ...
            u = this.tokenStore.expand(t).reduce(function(e, r) {
                ...
                return i > -1 && (n[i] = s * o * u), Object.keys(l.tokenStore.get(r)).forEach(function(t) {
                    a.add(t)
                }), e.union(a)
            }, new lunr.SortedSet);
        r.push(u)
...
lunr.Index.prototype.documentVector = function(t) {
    for (var e = this.documentStore.get(t), n = e.length, r = lunr.utils.zeroFillArray(this.corpusTokens.length), i = 0; n > i; i++) {
        var o = e.elements[i],
            s = this.tokenStore.get(o)[t].tf,
            l = this.idf(o);
        r[this.corpusTokens.indexOf(o)] = s * l
    }
...
lunr.stemmer = function() {
    ...
    return function(n) {
        ...
        if (c = n.substr(0, 1), "y" == c && (n = c.toUpperCase() + n.substr(1)), p = /^(.+?)(ss|i)es$/, f = /^(.+?)([^s])s$/, p.test(n) ? n = n.replace(p, "$1$2") : f.test(n) && (n = n.replace(f, "$1$2")), p = /^(.+?)eed$/, f = /^(.+?)(ed|ing)$/, p.test(n)) {
            ...
            o = m[1],
            f = RegExp(a),
            f.test(o) && (n = o, f = /(at|bl|iz)$/, d = RegExp("([^aeiouylsz])\\1$"), v = RegExp("^" + i + r + "[^aeiouwxy]$"), f.test(n) ? n += "e" : d.test(n) ? (p = /.$/, n = n.replace(p, "")) : v.test(n) && (n += "e"))
        }
        if (p = /^(.+?)y$/, p.test(n)) {
            var m = p.exec(n);
            o = m[1],
        ...
        if (p = /^(.+?)e$/, p.test(n)) {
            ...
            (p.test(o) || f.test(o) && !d.test(o)) && (n = o)
        }
...
lunr.TokenStore.prototype.add = function(t, e, n) {
    ...
    return r in n || (n[r] = {
        docs: {}
    }), 0 === i.length ? (n[r].docs[e.ref] = e, this.length += 1, void 0) : this.add(i, e, n[r])
},
